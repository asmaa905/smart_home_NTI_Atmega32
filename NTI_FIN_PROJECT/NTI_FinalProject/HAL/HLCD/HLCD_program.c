...
//	DIO_u8SetPortDirection(HLCD_DATA_PORT,DIO_u8_OUTPUT);
//	DIO_u8SetPinDirection(HLCD_CONTROL_PORT,HLCD_RS_PIN,DIO_u8_OUTPUT);
//	DIO_u8SetPinDirection(HLCD_CONTROL_PORT,HLCD_RW_PIN,DIO_u8_OUTPUT);
//	DIO_u8SetPinDirection(HLCD_CONTROL_PORT,HLCD_E_PIN,DIO_u8_OUTPUT);
//	/* LCD _init */
//	/*Wait for 30msec*/
//	_delay_ms(30);
//	HLCD_voidSendCommand(FUNCTION_SET);
...
//{
//	/* Steps */
//	/* 1- Select RS to be in command mode */
//	DIO_u8SetPinValue(HLCD_CONTROL_PORT,HLCD_RS_PIN,DIO_u8_LOW);
//	/* 2- Select Read Write to be write */
//	DIO_u8SetPinValue(HLCD_CONTROL_PORT,HLCD_RW_PIN,DIO_u8_LOW);
//    /* 3- put the configuration on the port */
//	DIO_u8SetPortValue(HLCD_DATA_PORT,Copy_u8Insrtuction);
//	/* 4- Enable the LCD */
//	DIO_u8SetPinValue(HLCD_CONTROL_PORT,HLCD_E_PIN,DIO_u8_HIGH);
//	_delay_ms(5);
//	/* 5-Disable the E pin */
//	DIO_u8SetPinValue(HLCD_CONTROL_PORT,HLCD_E_PIN,DIO_u8_LOW);
//}
//void HLCD_voidSendChar   (u8 Copy_u8Data)
//{
//	/* Steps */
//	/* 1- Select RS to be in command mode */
//	DIO_u8SetPinValue(HLCD_CONTROL_PORT,HLCD_RS_PIN,DIO_u8_HIGH);
//	/* 2- Select Read Write to be write */
//	DIO_u8SetPinValue(HLCD_CONTROL_PORT,HLCD_RW_PIN,DIO_u8_LOW);
//    /* 3- put the configuration on the port */
//	DIO_u8SetPortValue(HLCD_DATA_PORT,Copy_u8Data);
//	/* 4- Enable the LCD */
//	DIO_u8SetPinValue(HLCD_CONTROL_PORT,HLCD_E_PIN,DIO_u8_HIGH);
//	_delay_ms(5);
//	/* 5-Disable the E pin */
...
//{
//	u8 i=0;
//	while(Copy_u8PtrToString[i]!='\0')
//	{
//		HLCD_voidSendChar(Copy_u8PtrToString[i]);
//		i++;
//	}
//}
//void HLCD_voidSendInteger(u32 Copy_u8Integer)
//{
//	u8 Local_u8ArrayNumStr[10];
//	u8 i = 0,j;
//	while(Copy_u8Integer>0)
//	{
//		Local_u8ArrayNumStr[i] = (Copy_u8Integer%10)+'0';
//		i++;
//		Copy_u8Integer/=10;
//	}
//	for(j=i-1;j>=0;j--)
//	{
//		HLCD_voidSendChar(Local_u8ArrayNumStr[j]);
//		if(j==0) break;
//	}
//	/*u8 digit;
//	do
//	{
//		digit =  Copy_u8Integer %10;
//		HLCD_voidSendChar(digit+48);
